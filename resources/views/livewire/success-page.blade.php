                ...
                <div class="flex flex-wrap items-center pb-4 mb-10 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div class="w-full px-4 mb-4 md:w-1/4">
                        ...
                        <p class="text-base font-semibold leading-4 text-blue-600 dark:text-gray-400">
                           {{\Illuminate\Support\Number::currency($order->grand_total , 'INR')}}</p>
                    </div>
                    <div class="w-full px-4 mb-4 md:w-1/4">
                        <p class="mb-2 text-sm leading-5 text-gray-600 dark:text-gray-400 ">
                            Payment Method: </p>
                    ...
                    <div
                        ...
                        <div class="flex flex-col w-full space-y-6 ">
                            ...
                            <div
                                ...
                                <div class="flex justify-between w-full">
                                    ...
                                    <p class="text-base leading-4 text-gray-600 dark:text-gray-400"> {{\Illuminate\Support\Number::currency($order->grand_total , 'INR')}}</p>
                                </div>
                                <div class="flex items-center justify-between w-full">
                                    <p class="text-base leading-4 text-gray-800 dark:text-gray-400">Discount
                                    </p>
                                    <p class="text-base leading-4 text-gray-600 dark:text-gray-400"> {{\Illuminate\Support\Number::currency(0 , 'INR')}}</p>
                                </div>
                                <div class="flex items-center justify-between w-full">
                        ...
                        <div class="flex flex-col w-full px-2 space-y-4 md:px-8 ">
                            ...
                            <div class="flex items-start justify-between w-full">
                                ...
                                <p class="text-lg font-semibold leading-6 text-gray-800 dark:text-gray-400">{{\Illuminate\Support\Number::currency(0 , 'INR')}}</p>
                            </div>
                        </div>
                    </div>
                </div>
