                    ...
                    <table class="w-full">
                        ...
                        @forelse($cart_items as $item)
                            <tr wire:key="{{$item['product_id']}}">
                                ...
                                <td class="py-4">{{\Illuminate\Support\Number::currency($item['unit_amount'], "INR")}}</td>
                                <td class="py-4">
                                    <div class="flex items-center">
                                ...
                                <td class="py-4">{{\Illuminate\Support\Number::currency($item['total_amount'], "INR")}}</td>
                                <td>
            ...
            <div class="md:w-1/4">
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="flex justify-between mb-2">
                        <span>Sub Total</span>
                        <span>{{\Illuminate\Support\Number::currency($grandTotal, 'INR')}}</span>
                    </div>
                    <div class="flex justify-between mb-2">
                        <span>Taxes</span>
                        <span>{{\Illuminate\Support\Number::currency(0, 'INR')}}</span>
                    </div>
                    <div class="flex justify-between mb-2">
                        <span>Shipping</span>
                        <span>{{\Illuminate\Support\Number::currency(0, 'INR')}}</span>
                    ...
                    <div class="flex justify-between mb-2">
                        ...
                        <span class="font-semibold">{{\Illuminate\Support\Number::currency($grandTotal, 'INR')}}</span>
                    </div>
                    @if($cart_items)
