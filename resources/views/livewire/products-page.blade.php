            ...
            <div class="flex flex-wrap mb-24 -mx-3">
                <div class="w-full pr-2 lg:w-1/4 lg:block">
                            ...
                            @foreach($categories as $category)
                                <li wire:key="{{$category->id}}" class="mb-4">
                                    <label for="{{$category->slug}}" class="flex items-center dark:text-gray-400 ">
                                        <input id="{{$category->slug}}" value="{{$category->id}}" wire:model.live="selected_categories" type="checkbox" class="w-4 h-4 mr-2">
                        ...
                        <ul>
                            ...
                            <li class="mb-4">
                                <label for="sale" class="flex items-center dark:text-gray-300">
                                    <input id="sale" value="1" wire:model.live="sale" type="checkbox" class="w-4 h-4 mr-2">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
                        <div>
                            <div class="font-semibold text-blue-400">{{\Illuminate\Support\Number::currency($price_range, "INR")}}</div>
                            ...
                            <div class="flex justify-between ">
                                <span class="inline-block text-lg font-bold text-blue-400 ">{{\Illuminate\Support\Number::currency(1000,'INR')}}</span>
                                <span class="inline-block text-lg font-bold text-blue-400 ">{{\Illuminate\Support\Number::currency(500000, "INR")}}</span>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div wire:key="{{$product->id}}" class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3">
                                <div class="border border-gray-300 dark:border-gray-700">
                                    ...
                                    <div class="p-3 ">
                                        ...
                                        <p class="text-lg ">
                                            <span class="text-green-600 dark:text-green-600">{{\Illuminate\Support\Number::currency($product->price, "INR") }}</span>
                                        </p>
                                    </div>
